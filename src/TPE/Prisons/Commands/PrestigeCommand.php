    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args) {
        ...
        if(Utils::processTransaction($sender, Utils::getPrestigePrice($nextPrestige))) {
              ...
              foreach ($event->getCommands() as $command) {
                  Prisons::get()->getServer()->dispatchCommand(new ConsoleCommandSender($this->getServer(), $this->getServer()->getLanguage()), str_replace("{PLAYER"}, $event->getPlayer()->getName(), $command));
              }
